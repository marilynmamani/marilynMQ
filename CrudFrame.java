        ...
        menuReportesGeneral.addActionListener(
            new ActionListener(){
                public void actionPerformed(ActionEvent e){
                  ...
                  Object filas[][] = new Object[metodos.listaA.size()][4];
                  
                  ArrayList<DatosPersona> nuevaLista = metodos.listaA;
                  for(int i =0; i<nuevaLista.size();i++){
                      DatosPersona v = (DatosPersona)metodos.listaA.get(i);
                      filas[i][0]=v.nombres;
            ...
            new ActionListener(){
                public void actionPerformed(ActionEvent e){
                    ...
                    if(JOptionPane.showOptionDialog(null, msg,"Registrar", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE,null,null,null)==JOptionPane.OK_OPTION){
                        ...
                        metodos.registrarPersonaLista(dp);
